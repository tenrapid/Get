...
var windowFocusManager = require('windowfocusmanager');
...
var menuBarManager = {
	...
	fireControllerEvent: function() {
		var focused = windowFocusManager.getFocused(),
			controller = focused.window.Get && focused.window.Get.app && focused.window.Get.app.getMenuBarController();
		if (controller) {
			controller.fireEvent.apply(controller, arguments);
		}
	}
